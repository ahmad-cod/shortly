            ...
            <div className="px-6 h-full text-gray-800">
                <div className="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
                    <div className="grow-0 shrink-1 md:shrink-0 basis-auto xl:w-6/12 lg:w-6/12 md:w-9/12 mb-12 md:mb-0">
                        <img src={illustrationMockup} alt="" className="w-full" />
                    </div>
                    <div
                    ...
                    >
                        <form className="loginForm" onSubmit={handleSubmit}>
                            ...
                            <div class="text-center lg:text-left">
                                <button
                                    type="button"
                                    className="inline-block px-7 py-3 bg-cyan text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-darkviolet hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
                                >
                                    Login
                                </button>
                                <p className="text-sm font-semibold mt-2 pt-1 mb-0">
                                    ...
                                    <a
                                        href="#!"
                                        className="ml-2 text-darkviolet hover:text-red-700 focus:text-red-700 transition duration-200 ease-in-out"
                                    >Register</a
                                    >
                                </p>
                            </div>
